...
- 导入：左上角加号里导入 Markdown、TXT、文件夹或电子书（EPUB、Kindle、FB2、带章节的 TXT、HTML）。电子书出现在侧栏「书」，点阅读从上次停下的章节接着看；划线可摘到「摘录」；阅读页可朗读，英文专业词按单词读。齿轮 → 朗读 可选语种和音色。点章节仍是 Markdown。侧栏《廊下三章》是示例
...
电子书可以这样读：侧栏「书」里点阅读，会回到上次的章节和位置；划线后点「摘录」写进笔记；朗读只出现在阅读页，可把 Kubernetes、JSON 这类词按单词读出。齿轮 → 朗读 里可选语种和音色。点章节仍打开 Markdown。加号「电子书」可导入 EPUB、Kindle、FB2、带章节的 TXT 或 HTML。改完再导出本书，会带上作者和封面。`,
    },
  ];
