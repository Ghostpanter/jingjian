...
- 电子书：侧栏单独成「书」，点阅读从上次章节和位置接着看；划线摘到「摘录」；阅读页可朗读（只在电子书阅读时出现，用系统语音；中英可混读，专业词按单词而不是字母。齿轮 → 朗读 可选语种和音色）。导入 EPUB、Kindle、FB2、带章节的 TXT 或 HTML，按目录分章；导出带作者和封面。点章节仍打开 Markdown
